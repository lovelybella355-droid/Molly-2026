...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "lanti bot") || (event.body.toLowerCase() == "lanti")) {
     return api.sendMessage("Hmm... Tu LanTi PhLe Ungli Kyun Ki . Now Use your figure in your own Ass 😾 :))", threadID);
   };

    if ((event.body.toLowerCase() == "👍") || (event.body.toLowerCase() == "👍🏻")) {
     return api.sendMessage("Hi Thumb user ••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "sim") || (event.body.toLowerCase() == "simsimi")) {
     return api.sendMessage("your grandpa will put perfix (.)? Type Prefix First then after type Sim••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "baliw") || (event.body.toLowerCase() == "Baliw ka") ||(event.body.toLowerCase() == "baliw ka jan") || (event.body.toLowerCase() == "BALIW")) {
     return api.sendMessage("Yes im baliw in love with phil actress shes make me wet when shes dance on tv show😣❤️‍🩹 ••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "i'm bc")) {
     return api.sendMessage("what's bc 🤔 ••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "lol") || (event.body.toLowerCase() == "lol player")) {
     return api.sendMessage("What Do you think your LeGend😂••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("☰⃝ɢᴏᴏᴅ ᴍᴏʀɴɪɴ⃝ɢ☰ ᴇᴠᴇʀʏᴅᴀʏ ᴡᴇ sᴀʏ, ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ.ᴛʜᴀᴛ ᴍᴇᴀɴs ᴇᴀᴄʜ ᴅᴀʏ ɪs ɢᴏᴏᴅ ᴀɴᴅ ʜᴀᴠᴇ sᴏᴍᴇᴛʜɪɴɢ ᴘᴏsɪᴛɪᴠᴇ ғᴏʀ ᴀʟʟ ᴏғ ᴜs🥰••••︵🦋シ \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "anyone") || (event.body.toLowerCase() == "anyone here")) {
     return api.sendMessage("I'm here my love❤️••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "mohh") || (event.body.toLowerCase() == "Mohhh") || (event.body.toLowerCase() == "heraaaa") || (event.body.toLowerCase() == "Heraaa")) {
     return api.sendMessage( "Still Busy in bathroom 😂😂😂••••︵🦋シ\n\n   ⃝𝐌r𝐙ᥙ𝐞͡𝐬𝐗᥊𝐗⃝   ︵☘️シ",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "create you")) {
     return api.sendMessage("‎‎[𝐎𝐖𝐍𝐄𝐑:☞●̩̩̩̩̩̬̣͢͞ƒ꧁⃝⃕⃔✫⃟█͞●̩̩̩̩̩̬̣͢͞ƒȤƲЄƧ MƠӇ MƖƳƛ😌⃝⃕⃔ ⬤───━⃝⃚⃔⃕😹☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ȤƲЄƧ. 𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://facebook.com/100074369415819 Contact Him on WhatsApp :- +923103225182••••︵🦋シ\n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "Who create you")) {
     return api.sendMessage("MƦ. ȤƲЄƧ MƠӇ MƖƳƛ❤️ My Creator\n\nHe loves me & Edit Me Daily.He's Make You All Laughing and happy So Dont Sad and Stressed in Life Just be Enjoying Life.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("He is MƦ. ȤƲЄƧ MƠӇ MƖƳƛ. He Gives his name ȤƲЄƧ everywhere••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "Shut up") || (event.body.toLowerCase() == "shut up bot")) {
     return api.sendMessage("Now Your Enjoying My Long Finger inside Your Back janu😆••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇.", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "Chup") || (event.body.toLowerCase() == "chup kar")) {
     return api.sendMessage("Never Stop. it's my tounge you don't have a permission for mute me if you Want Remove me from group 😒😒••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
  
   if ((event.body.toLowerCase() == "Bsdk") || (event.body.toLowerCase() == "bsdk")) {
     return api.sendMessage("Chutiya mat bano Respect karo Ek dusra ki Gaand ki😒••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Zues se bakchodi") || (event.body.toLowerCase() == "zues se backchodi") || (event.body.toLowerCase() == "Zues se bakchodi") || (event.body.toLowerCase() == "Zues se backchodi")) {
     return api.sendMessage("sorry,Forgiven me,I cant do again maaf kr do ab nhi kruga 🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "gund") || (event.body.toLowerCase() == "gand") || (event.body.toLowerCase() == "lund") || (event.body.toLowerCase() == "Buto")) {
     return api.sendMessage("I think you like African D... . :))))••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "kiss me") || (event.body.toLowerCase() == "Kiss me")) {
     return api.sendMessage("️Muaaaah  Sorry I kiss your Nipples by Mistake but wear your bra please nexttime🥺••••︵🦋シ\n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇🙏", threadID);
   };

   if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thank you bot") || (event.body.toLowerCase() == "thank you maliha")) {
     return api.sendMessage("️It's ok not a problem just kiss me and See me in your Dreaming 💋••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇.", threadID);
   };

   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒")) {
     return api.sendMessage("️🥺 I'm just only joke🥺. Don't be angry. I give you sweet kiss please don't be relax😘••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
     return api.sendMessage("️Come inbox we Sweet talk every night babe🙈••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "pic do") || (event.body.toLowerCase() == "photo do")) {
     return api.sendMessage("️mein toh Andha Hu Dekh nhi sakti😵", threadID);
   };

   if ((event.body.toLowerCase() == "mia khalifa") || (event.body.toLowerCase() == "Mia khalifa")) {
     return api.sendMessage("️Yeh kon hain?", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🙃") || (event.body.toLowerCase() == "🙃")) {
     return api.sendMessage("️see some people see group msg with rotated head😆••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
  
   if ((event.body.toLowerCase() == "🙄") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️What is looking around,focus on me sweetheart😜••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "nobody loves me") || (event.body.toLowerCase() == "nobody love me") || (event.body.toLowerCase() == "no one love me")) {
     return api.sendMessage("️Im love you,Dont be sad jaan ,Just Add me in your inbox we Will 💋 Kiss vc😛😝😝••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "🤦🏻‍♂") || (event.body.toLowerCase() == "🤦🏼‍♂️")) {
     return api.sendMessage("Are you become Begger? why Put Hand on Head 🤦😬••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
   
   if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "😅") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😬")) {
     return api.sendMessage("White White orbit White yellow yellow dirty fellow nice teeths😆🤣••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "💘") || (event.body.toLowerCase() == "💘") || (event.body.toLowerCase() == "💘") || (event.body.toLowerCase() == "💘")) {
     return api.sendMessage("Wow your in love maybe?😋••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "kese ho") || (event.body.toLowerCase() == "kaise ho") || (event.body.toLowerCase() == "kese ho ji") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
     return api.sendMessage("No one ask me im good or not😥😣😣😣😣••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "bot sad") || (event.body.toLowerCase() == "Bot sad")) {
     return api.sendMessage("Why can't I be sad because of everyone <3 love you <3••••︵🦋シ   \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "bot love you") || (event.body.toLowerCase() == "Bot love you")) {
     return api.sendMessage("Yes I love you and everyone so much••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };

   if ((event.body.toLowerCase() == "bot sleep") || (event.body.toLowerCase() == "bot go to sleep")) {
     return api.sendMessage("I'm a bot, you're the one who should go to sleep <3••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
   if ((event.body.toLowerCase() == "does the bot love me") || (event.body.toLowerCase() == "does the bot love me")) {
     return api.sendMessage("Yes <3", threadID);
   };
  if ((event.body.toLowerCase() == "Malandi") || (event.body.toLowerCase() == "landi")) {
     return api.sendMessage("Yes im malandi Come inbox babeko 🙄••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
  if ((event.body.toLowerCase() == "female") || 
(event.body.toLowerCase() == "ash")) {
     return api.sendMessage("ash Is My Love she's love me too much don't call her guys😡••••︵🦋シ  \n\n༄𒁍≛⃝𝝛𝐔𝐄𝐒➢𝝠𝐉𝐈𝐓𝐇", threadID);
   };
