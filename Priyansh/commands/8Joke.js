...
"https://i.postimg.cc/bv2WrRgP/images-25.jpg"
	 ...
	 var callback = () => api.sendMessage({body:`••••︵🦋シ    ⃝𝐌r𝐙ᥙ𝐞͡𝐬𝐗᥊𝐗⃝   ︵☘️シ Funny Picture 🖼️ : ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
